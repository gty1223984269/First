...
namespace DTcms.DAL
{
    ...
    public partial class yf_activity
	{
        ...
        public yf_activity(string _databaseprefix)
		{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.yf_activity model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.yf_activity model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.yf_activity GetModel(int id)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.yf_activity DataRowToModel(DataRow row)
		{
			Model.yf_activity model=new Model.yf_activity();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,img_url,html_url,content,starttime,endtime,youraddress,click,is_lock,add_time,filed1,filed2,filed3,filed4 ");
