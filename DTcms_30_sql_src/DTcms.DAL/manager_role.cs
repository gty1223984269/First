...
namespace DTcms.DAL
{
    ...
    public partial class manager_role
    {
        ...
        public DataSet getrole(string name)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select role_id from " + databaseprefix + "manager");
        ...
        public DataSet getSchoolCityId(string name)
        {


            StringBuilder strSql = new StringBuilder();
            strSql.Append("select SchoolId,CityId from " + databaseprefix + "manager");
            strSql.Append(" where user_name='" + name + "'");
