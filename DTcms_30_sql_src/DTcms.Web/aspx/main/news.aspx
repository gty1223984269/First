...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by DTcms Template Engine at 2015/1/9 18:31:16.
		本页面代码由DTcms模板引擎生成于 2015/1/9 18:31:16. 
	*/
	...
	templateBuilder.Append("-->\r\n        \r\n      <li class=\"lifenlei\"; style=\"cursor:pointer\"> <a href=\"");
	templateBuilder.Append(linkurl("news_list",Utils.ObjectToStr(cdr["id"])));

	templateBuilder.Append("\" title=\"查看更多\" >" + Utils.ObjectToStr(cdr["title"]) + "</a></li> \r\n           \r\n       <!-- <dd>\r\n          <span><a href=\"");
	templateBuilder.Append(linkurl("news_list",Utils.ObjectToStr(cdr["id"])));
	...
	templateBuilder.Append("\r\n            </ul>\r\n    <div class=\"juti\">\r\n        \r\n   ");
	DataTable c = get_category_child_list("news", 0);

	templateBuilder.Append("\r\n    <ul>\r\n         ");
	int cdd__loop__id=0;
	foreach(DataRow cdd in c.Rows)
	{
		cdd__loop__id++;


	templateBuilder.Append("\r\n     <li style=\"float:left;border:dashed 1px blue;margin-left:20px\">\r\n    " + Utils.ObjectToStr(cdd["title"]) + " <span><a href=\"");
	templateBuilder.Append(linkurl("news_list",Utils.ObjectToStr(cdd["id"])));

	templateBuilder.Append("\" title=\"查看更多\" >查看更多</a></span>\r\n       <p>\r\n       ");
	DataTable listNews = get_article_list("news", Utils.StrToInt(Utils.ObjectToStr(cdd["id"]), 0),5, "status=0");
