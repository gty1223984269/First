    ...
    public partial class article_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.type = Session["type"].ToString();
            }
            catch { 
            }
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind(this.type,this.City,this.School,this.user,this.channel_id, this.category_id, "id>0" + CombSqlTxt(this.keywords, this.property), "sort_id asc,add_time desc,id desc");
            }
        }
        ...
        private void RptBind(string Type,string City,string School,string user,int _channel_id, int _category_id,string _strWhere, string _orderby)
        {
            ...
            switch (this.prolistview)
            {
                case "Txt":
                    ...
                    this.rptList1.DataSource = bll.GetList(type,City,School,user,_channel_id, _category_id, this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
                    this.rptList1.DataBind();
                    break;
                default:
                    this.rptList1.Visible = false;
                    this.rptList2.DataSource = bll.GetList(type, City, School, user, _channel_id, _category_id, this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            this.RptBind(this.type, this.City, this.School,this.user, this.channel_id, this.category_id, "id>0" + CombSqlTxt(this.keywords, this.property), "sort_id asc,add_time desc,id desc");
        }
