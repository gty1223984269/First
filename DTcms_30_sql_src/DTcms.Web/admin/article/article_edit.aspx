...
<%--  <dl>
  ...
  <%--<dl>
    ...
    <dd>
      ...
      <%--  <asp:ListItem Value="0" >市级审核</asp:ListItem>--%>
      <%--  </asp:RadioButtonList>--%>
       <%--   <asp:RadioButtonList ID="RBschool" runat="server">
                <asp:ListItem Value="0">提交到校</asp:ListItem>
                <asp:ListItem Value="1">校审核</asp:ListItem>
          </asp:RadioButtonList>--%>
        
      <%--</div>--%>
      <%--  <div class="rule-multi-radio" >
           <asp:RadioButtonList ID="RBcity" runat="server">
       <asp:ListItem Value="0">提交到市</asp:ListItem>
        <asp:ListItem Value="1">市审核</asp:ListItem>
         </asp:RadioButtonList>
