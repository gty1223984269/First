    ...
    public partial class activity_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //RptBind("id>0" + CombSqlTxt(this.type,keywords), "id desc");
            }
        }
        #region 绑定类别=================================
        private void TreeBind()
        {
            ...
            this.ddlTypeId.Items.Add(new ListItem("所有广告", ""));
        ...
        //    if (this.type > 0)
        //    {
        //        this.ddlTypeId.SelectedValue = this.type.ToString();
        //    }
        ...
        #region 返回用户状态=============================
        protected string GetSpace(int type)
        {
        ...
        protected void ddlGroupId_SelectedIndexChanged(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("activity_list.aspx", "type={0}&keywords={1}",
                ddlTypeId.SelectedValue, this.keywords));
        }
