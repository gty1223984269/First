...
class XXTEA
{
    ...
    public static string Encrypt(string encryptString, string encryptKey)
    {
        try
        {
            ...
            Byte[] data = Encrypt(encoder.GetBytes(encryptString), encoder.GetBytes(encryptKey));
    ...
    public static string Decrypt(string decryptString, string decryptKey)
    {
        ...
        {
            System.Text.Encoding encoder = System.Text.Encoding.UTF8;
            return encoder.GetString(Decrypt(System.Convert.FromBase64String(decryptString), encoder.GetBytes(decryptKey)));
        }
        catch
        {
